...
p1 <- ggplot(D3, aes(score)) + facet_wrap(~measure, scales = "free")+ geom_histogram(stat = "count")
(p1)

#Then visualize the relationships between variables
p1 <- ggplot(D1, aes(score)) + facet_wrap(~measure, scales = "free") + geom_histogram(stat = "count")
...
library(rpart)
c.tree1 <- rpart(level.up ~av.assignment.score+ messages + pre.test.score, method = "class", data = D1, control=rpart.control(minsplit=1, minbucket=1, cp=0.001))
printcp(c.tree1)
plot(c.tree1)
